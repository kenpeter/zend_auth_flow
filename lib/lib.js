...
exports.getTotalTicketNum = function getTotalTicketNum(accessToken) {
  return new Promise((resolve, reject) => {
    // Hardcode: Human time (GMT): Friday, 9 June 2017 16:21:01
    const unixTime = 1497025261;
    // Able to pull all tickets that time
...
exports.getNewToken = function getNewToken() {
  return new Promise((resolve, reject) => {
    ...
    // Here we use username and password combo.
    request.post({
      url,
      body: jsonDataObj,
      json: true,
...
exports.isNormalInteger = function isNormalInteger(str) {
